...
('USER_VIEW', 'View user list', 'Allow viewing user account list', 'User Management'),
('USER_CREATE', 'Create new user', 'Allow creating new user account', 'User Management'),
('USER_EDIT', 'Edit user', 'Allow editing user information', 'User Management'),
('USER_ACTIVATE', 'Activate/Deactivate', 'Allow activating or deactivating account', 'User Management'),
('EMPLOYEE_VIEW', 'View employee list', 'Allow viewing employee information', 'Employee Management'),
('EMPLOYEE_CREATE', 'Add new employee', 'Allow adding new employee to system', 'Employee Management'),
('EMPLOYEE_EDIT', 'Edit employee', 'Allow editing employee information', 'Employee Management'),
('EMPLOYEE_DELETE', 'Delete employee', 'Allow deleting employee from system', 'Employee Management'),
('DEPT_VIEW', 'View department', 'Allow viewing department list', 'Department Management'),
('DEPT_CREATE', 'Create department', 'Allow creating new department', 'Department Management'),
('DEPT_EDIT', 'Edit department', 'Allow editing department information', 'Department Management'),
('DEPT_DELETE', 'Delete department', 'Allow deleting department', 'Department Management'),
('CONTRACT_VIEW', 'View contract', 'Allow viewing contract list', 'Contract Management'),
('CONTRACT_CREATE', 'Create contract', 'Allow creating new contract', 'Contract Management'),
('CONTRACT_EDIT', 'Edit contract', 'Allow editing contract', 'Contract Management'),
('CONTRACT_DELETE', 'Delete contract', 'Allow deleting contract', 'Contract Management'),
('CONTRACT_APPROVE', 'Approve contract', 'Allow approving contract', 'Contract Management'),
('JOB_VIEW', 'View job posting', 'Allow viewing job posting list', 'Job Posting'),
('JOB_CREATE', 'Create job posting', 'Allow creating new job posting', 'Job Posting'),
('JOB_EDIT', 'Edit job posting', 'Allow editing job posting', 'Job Posting'),
('JOB_DELETE', 'Delete job posting', 'Allow deleting job posting', 'Job Posting'),
('SYSTEM_CONFIG', 'System configuration', 'Allow configuring system settings', 'System Settings'),
('ROLE_MANAGE', 'Manage roles', 'Allow managing user roles', 'System Settings'),
('PERMISSION_MANAGE', 'Manage permissions', 'Allow managing role permissions', 'System Settings');
-- Additional permissions added for finer-grained control
INSERT IGNORE INTO permissions (code, name, description, category) VALUES
('SALARY_VIEW', 'View salary', 'Allow viewing salary and related reports', 'Salary'),
('SALARY_IMPORT', 'Import salary', 'Allow importing salary file (CSV) and updating data', 'Salary'),
('SALARY_CALCULATE', 'Calculate salary', 'Allow performing salary calculation for period', 'Salary'),
('SALARY_ADJUST', 'Adjust salary', 'Allow adjusting bonus/penalty for employees', 'Salary'),
('SALARY_EXPORT', 'Export payroll/payslip', 'Allow exporting payslip or payroll report', 'Salary'),
('REQUEST_VIEW', 'View request', 'Allow viewing request/proposal list', 'Request'),
('REQUEST_CREATE', 'Create request', 'Allow creating request (e.g. leave, attendance correction)', 'Request'),
('REQUEST_APPROVE', 'Approve request', 'Allow approving or rejecting requests', 'Request'),
('ATTENDANCE_VIEW', 'View attendance', 'Allow viewing attendance report', 'Attendance'),
('ATTENDANCE_ADJUST', 'Adjust attendance', 'Allow manually editing attendance records', 'Attendance'),
('TASK_VIEW', 'View task', 'Allow viewing task list', 'Task'),
('TASK_CREATE', 'Create task', 'Allow creating new task', 'Task'),
('TASK_ASSIGN', 'Assign task', 'Allow assigning task to others', 'Task'),
('TASK_EDIT', 'Edit task', 'Allow editing task', 'Task'),
('TASK_UPDATE_STATUS', 'Update status', 'Allow updating task status', 'Task'),
('TASK_CANCEL', 'Cancel task', 'Allow canceling task', 'Task'),
('ATTENDANCE_IMPORT', 'Import attendance', 'Allow importing attendance data from file', 'Attendance'),
('ATTENDANCE_EXCEPTION_SUBMIT', 'Submit exception', 'Allow submitting attendance exception request', 'Attendance'),
('ATTENDANCE_EXCEPTION_APPROVE', 'Approve exception', 'Allow approving attendance exception request', 'Attendance'),
('ATTENDANCE_REPORT', 'Attendance report', 'Allow viewing and exporting attendance report', 'Attendance'),
('PAYROLL_VIEW', 'View payroll', 'Allow viewing payroll information', 'Payroll'),
('PAYROLL_CALCULATE', 'Calculate payroll', 'Allow calculating payroll', 'Payroll'),
('PAYROLL_APPROVE', 'Approve payroll', 'Allow approving payroll', 'Payroll'),
('PAYROLL_EXPORT', 'Export payroll', 'Allow exporting payroll file', 'Payroll'),
('REPORT_VIEW', 'View report', 'Allow accessing system reports', 'Reporting'),
('REPORT_EXPORT', 'Export report', 'Allow exporting report file', 'Reporting'),
('ANALYTICS_VIEW', 'View analytics', 'Allow viewing analytics dashboard', 'Reporting'),
('HR_DASHBOARD_VIEW', 'View HR Dashboard', 'Allow accessing HR dashboard', 'Reporting'),
('DASHBOARD_VIEW', 'View Dashboard', 'View overview page', 'Dashboard');
