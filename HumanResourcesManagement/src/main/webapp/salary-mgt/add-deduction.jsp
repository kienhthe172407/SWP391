...
<head>
    ...
    <title>Add Deduction Type - HR Management System</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <jsp:include page="/components/header.jsp">
            <jsp:param name="pageTitle" value="Add Deduction Type" />
        </jsp:include>
        ...
        <div class="content-area">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-minus-circle me-2"></i>Deduction Type Information</h5>
                </div>
                <div class="card-body">
                    <form method="POST" action="${pageContext.request.contextPath}/salary/add-deduction" class="needs-validation" novalidate id="addDeductionForm">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="deductionName" name="deductionName" 
                                       value="${param.deductionName}" required maxlength="100"
                                       placeholder="e.g., Income Tax, Social Insurance">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"
                                      placeholder="Describe this deduction type...">${param.description}</textarea>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="isMandatory" name="isMandatory" 
                                       ${param.isMandatory == 'on' || param.isMandatory == null ? 'checked' : ''}>
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Save Deduction Type
                            </button>
                        </div>
                    </form>
                </div>
