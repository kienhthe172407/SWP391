...
<head>
    ...
    <title>Create Job Posting - HR Management System</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <jsp:include page="/components/header.jsp">
            <jsp:param name="pageTitle" value="Create Job Posting" />
        </jsp:include>
        ...
        <div class="content-area">
            ...
            <div class="card form-card">
                ...
                <div class="form-header">
                    <h2 class="mb-0">
                        <i class="fas fa-plus-circle me-2"></i>Create New Job Posting
                    </h2>
                    <p class="mb-0 mt-2">Fill in the details below to create a new job posting</p>
                </div>
                
                <form method="POST" action="${pageContext.request.contextPath}/job-postings/create" id="jobPostingForm">
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="jobDescription" name="jobDescription" 
                                      rows="6" placeholder="Describe the job responsibilities, duties, and expectations..." required></textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="requirements" name="requirements" 
                                      rows="4" placeholder="List the required qualifications, skills, and experience..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="benefits" name="benefits" 
                                      rows="4" placeholder="List the benefits and perks offered..."></textarea>
                        </div>
                    </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="internalNotes" name="internalNotes" 
                                          rows="3" placeholder="Internal notes for HR team (not visible to applicants)..."></textarea>
                            </div>
                        </div>
                    </c:if>
