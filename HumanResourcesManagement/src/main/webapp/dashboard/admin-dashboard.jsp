...
<body>
    ...
    <div class="main-content">
        <div class="top-header">
            ...
            <div class="user-info">
                <span><c:out value="${sessionScope.user.roleDisplayName}" default="Admin"/></span>
                <div class="dropdown">
        ...
        <div class="content-area">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h4 class="mb-1">Welcome back, <c:out value="${sessionScope.user.fullName}" default="System Administrator"/></h4>
                                    <p class="text-muted mb-0">Manage system users, roles, and configurations.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-exclamation-triangle me-2"></i>System Alerts</div>
                        <div class="card-body">
                            <h3 class="mb-0">2</h3>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-user-shield me-2"></i>Role Management</div>
                        <div class="card-body">
                            <p class="text-muted">Manage user roles and permissions throughout the system.</p>
                            <div class="d-flex gap-2">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-database me-2"></i>Database Management</div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-chart-line me-2"></i>System Monitoring</div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="text-muted">View system logs and audit trails for security monitoring.</p>
                            <div class="d-flex gap-2">
                                <a href="#" class="btn btn-primary">
            ...
            <div class="row g-3 mt-3">
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-history me-2"></i>Recent System Activity</div>
                        <div class="card-body">
            ...
            <div class="row g-3 mt-3">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header"><i class="fas fa-chart-pie me-2"></i>User Role Distribution</div>
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <div class="text-center">
                                        <div class="bg-secondary text-white rounded-circle d-inline-flex align-items-center justify-content-center mb-2" style="width: 60px; height: 60px;">
