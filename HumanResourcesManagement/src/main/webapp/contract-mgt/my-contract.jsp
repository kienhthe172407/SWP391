...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="${pageContext.request.contextPath}/employee/my-contract" class="active">
            ...
            <div class="user-info">
                ...
                <div class="dropdown">
                    <button class="btn dropdown-toggle avatar" type="button" id="userDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <c:out value="${employee.firstName.substring(0,1)}${employee.lastName.substring(0,1)}" default="EMP"/>
                    </button>
