...
public abstract class DBContext {
    ...
    public DBContext() {
        try {
            ...
            String user = "root";
            String pass = "123456";
            String url = "jdbc:mysql://127.0.0.1:3306/hr_management_system?allowPublicKeyRetrieval=true&useSSL=false&serverTimezone=UTC&characterEncoding=UTF-8&useUnicode=true";
